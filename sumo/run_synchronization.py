...
class SimulationSynchronization(object):
    ...
    def tick(self):
        ...
        for sumo_actor_id in self.sumo2carla_ids:
            ...
            carla_velocity = sumo_actor.velocity

            self.carla.synchronize_vehicle(carla_actor_id, carla_transform, carla_lights, carla_velocity)
        ...
        # -----------------
        self.carla.tick()
        # print_actor_velocity(self.carla.world)
