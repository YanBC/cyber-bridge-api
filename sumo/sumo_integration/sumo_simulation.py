...
class SumoSimulation(object):
    ...
    def get_actor(actor_id):
        ...
        pitch = results[traci.constants.VAR_SLOPE]
        yaw = results[traci.constants.VAR_ANGLE]
        ...
        speed_x = -speed * math.cos(math.radians(yaw + 90))
        speed_y = -speed * math.sin(math.radians(yaw + 90))
        velocity = carla.Vector3D(speed_x, speed_y, 0)

        # print("speed:{}, yaw:{}, speed_x:{}, speed_y:{}".format(speed, yaw, speed_x, speed_y))
