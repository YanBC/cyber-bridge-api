...
class DynamicObjectCrossingWithStop(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        actor_drive = DriveDistance(self.other_actors[0],
                                    0.5 * self._reference_waypoint.lane_width,
        ...
        actor_continue_condition = TriggerVelocity(self.ego_vehicles[0], 1e-5, 
        ...
        keep_velocity.add_child(actor_drive_to_ego_lane_id)
